    ...
    <div className="w-full font-sans md:px-10" ref={containerRef}>
      <div ref={ref} className="relative max-w-7xl mx-auto pb-5">
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="sticky flex flex-col min-w-min md:min-w-60 md:flex-row z-40 items-center top-40 self-center md:self-start max-w-xs lg:max-w-sm md:w-fit">
              ...
              <div className="h-6 md:h-10 absolute bg-[#43A047]/40 left-5 md:left-3 w-6 md:w-10 rounded-full  flex items-center justify-center shadow-md">
                {/* Inner dot */}
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3 className="md:hidden block text-xl md:text-2xl mb-0 md:mb-4 text-left font-bold text-[#1B6B2A]">
                {item.title}
              </h3>
        ...
        <div
          ...
          from-transparent via-[#43A047] to-transparent 
        ...
        >
          <motion.div
            ...
            bg-gradient-to-t from-[#1B6B2A] via-[#43A047] to-[#8BC34A] 
            rounded-full shadow-[0_0_8px_rgba(67,160,71,0.45)]"
          />
        </div>
      </div>
    </div>
