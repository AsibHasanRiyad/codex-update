export const servicesData = [
  {
    ...
    processTagline: "Strategy & scalable engineering",
    processIntro:
      "We combine deep technical expertise with structured delivery practices to ensure your web project is built right — on time, on budget, and built to last.",
    processSteps: [
      {
        step: 1,
        title: "Discover & Plan",
